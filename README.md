...
- [Main LAB Dashboard](docs/features/2026-04-13-main-lab-dashboard.md)  `[工具属性]`
...
- [Killjoy: CronFlow Security Audit Tool](docs/features/2026-04-04-killjoy-cronflow-audit.md)  `[安全与风险属性]`
...
- [DupeSleuth](docs/features/2026-04-03-dupe-sleuth.md)  `[工具属性]`
...
- [Memory File Organizer](docs/features/2026-04-02-commander-memory-organizer.md)  `[工具属性]`

### 2026-04-01
- [Killjoy Config Vuln Scanner](docs/features/2026-04-01-killjoy-config-vuln-scanner.md)  `[安全与风险属性]`
- [log-scout](docs/features/2026-04-01-log-scout.md)  `[监控观测属性]`
- [log_level_digest.py](docs/features/2026-04-01-main-log-level-digest.md)  `[监控观测属性]`
- [Sidequest Status Scan](docs/features/2026-04-01-maker-sidequest-status-scan.md)  `[监控观测属性]`
- [Tone & Rhythm Text Analyzer](docs/features/2026-04-01-vibe-tone-analyzer.md)  `[设计与内容属性]`
...
- [CronFlow](docs/features/2026-04-04-cronflow.md)  `[2026-04-04]`
- [Status Glance (Maker Sidequest)](docs/features/2026-04-03-maker-status-glance.md)  `[2026-04-03]`
- [status-lens](docs/features/2026-04-03-main-status-lens.md)  `[2026-04-03]`
- [API Pulse Checker (MVB)](docs/features/2026-04-02-api-health-checker.md)  `[2026-04-02]`
- [Sidequest Status Scan](docs/features/2026-04-01-maker-sidequest-status-scan.md)  `[2026-04-01]`
- [log_level_digest.py](docs/features/2026-04-01-main-log-level-digest.md)  `[2026-04-01]`
...
│       ├── 2026-04-03-dupe-sleuth.md
│       ├── 2026-04-03-commander-api-tester.md
│       ├── 2026-04-02-commander-memory-organizer.md
│       ├── 2026-04-02-api-health-checker.md
│       ├── 2026-04-01-vibe-tone-analyzer.md
│       ├── 2026-04-01-maker-sidequest-status-scan.md
│       ├── 2026-04-01-main-log-level-digest.md
│       ├── 2026-04-01-log-scout.md
│       ├── 2026-04-01-killjoy-config-vuln-scanner.md
├── archive/
│   ├── nightly-tools/
│   └── nightly-sidequests/
└── .github/workflows/nightly-sync-index.yml
```

## 自动化维护
- 同步：`python3 scripts/sync_nightly.py --source-root /root/.openclaw/workspace --repo-root .`
- 重建索引：`python3 scripts/build_index.py --repo-root .`
- Actions：`.github/workflows/nightly-sync-index.yml`（定时 + 手动）

## 信息架构说明（IA）
1. 双索引并行：日期索引追踪时间线；模块索引支持能力复用。
2. 功能页独立：每个任务固定 6 段结构，便于审计与自动更新。
3. 文档与产物分层：`docs/` 放说明，`archive/` 放原始产物。
4. 占位显式化：空目录任务也生成页面并标注状态，避免遗漏。
