...
- 日期：`2026-04-08`
- 模块：`监控观测属性`
- 来源：`archive/nightly-sidequests/2026-04-08-maker-status-digest`

## 功能简介
Small zero-dependency Python tool for parsing nightly `status.jsonl` and showing:

## 背景/目的
该页面用于沉淀 `2026-04-08-maker-status-digest` 的用途、运行方式和交付状态，避免夜间任务信息散落。

## 目录与文件
- 根目录：`archive/nightly-sidequests/2026-04-08-maker-status-digest`
- 文件列表：
  - `README.md`
  - `status_digest.py`
