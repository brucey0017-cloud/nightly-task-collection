...
- 日期：`2026-04-06`
- 模块：`工具属性`
- 来源：`archive/nightly-tools/2026-04-06-api-response-validator`

## 功能简介
A self-contained, zero-dependency Python 3 CLI tool for validating HTTP JSON API responses against simple expectations.

## 背景/目的
该页面用于沉淀 `2026-04-06-api-response-validator` 的用途、运行方式和交付状态，避免夜间任务信息散落。

## 目录与文件
- 根目录：`archive/nightly-tools/2026-04-06-api-response-validator`
- 文件列表：
  - `README.md`
  - `api-validator.py`
  - `config.json`
