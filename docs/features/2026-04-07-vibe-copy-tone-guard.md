...
- 日期：`2026-04-07`
- 模块：`设计与内容属性`
- 来源：`archive/nightly-sidequests/2026-04-07-vibe-copy-tone-guard`

## 功能简介
A tiny Python 3 helper to catch cliché Chinese marketing phrases and overlong lines.

## 背景/目的
该页面用于沉淀 `2026-04-07-vibe-copy-tone-guard` 的用途、运行方式和交付状态，避免夜间任务信息散落。

## 目录与文件
- 根目录：`archive/nightly-sidequests/2026-04-07-vibe-copy-tone-guard`
- 文件列表：
  - `README.md`
  - `copy_tone_guard.py`
  - `sample_copy.txt`
