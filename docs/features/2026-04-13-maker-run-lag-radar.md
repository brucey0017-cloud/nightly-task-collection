...
- 日期：`2026-04-13`
- 模块：`流程自动化属性`
- 来源：`archive/nightly-sidequests/2026-04-13-maker-run-lag-radar`

## 功能简介
Tiny zero-dependency CLI for nightly workflow visibility.

## 背景/目的
该页面用于沉淀 `2026-04-13-maker-run-lag-radar` 的用途、运行方式和交付状态，避免夜间任务信息散落。

## 目录与文件
- 根目录：`archive/nightly-sidequests/2026-04-13-maker-run-lag-radar`
- 文件列表：
  - `README.md`
  - `run_lag_radar.py`
